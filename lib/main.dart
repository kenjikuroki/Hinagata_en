...
class _HomePageState extends State<HomePage> with RouteAware {
  ...
  Quiz? _getDailyQuiz() {
    ...
    final all = _appData!.questions.values.expand((e) => e).toList();
  ...
  void _showDailyCommandSheet(Quiz quiz) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
      isScrollControlled: true,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.terminal_rounded, size: 18, color: Color(0xFF2E7D32)),
                  ),
              ...
              SoftSurface(
                ...
                borderColor: AppColors.line.withValues(alpha: 0.8),
  ...
  Widget _buildDailyCommand() {
    final quiz = _getDailyQuiz();
    if (quiz == null) return const SizedBox.shrink();

    return GestureDetector(
      onTap: () => _showDailyCommandSheet(quiz),
      child: Container(
        width: double.infinity,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            achieved
                ? '$_dailyGoalTarget Done! ✓'
                : '$_todayAnsweredCount / $_dailyGoalTarget',
            style: TextStyle(
              fontSize: 16,
  ...
  Widget _buildTopSelectors() {
    final achieved = _todayAnsweredCount >= _dailyGoalTarget;
    final progress = (_todayAnsweredCount / _dailyGoalTarget).clamp(0.0, 1.0);
    final goalColor = achieved ? const Color(0xFF4CAF50) : AppColors.accent;
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      achieved ? 'Done ✓' : '$_todayAnsweredCount / $_dailyGoalTarget',
                      style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.w900,
                        color: goalColor,
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    value: progress,
                    minHeight: 4,
                    backgroundColor: AppColors.line.withValues(alpha: 0.35),
      ...
      children: [
        ...
        Expanded(
          child: _HomeStatCard(
            ...
            label: streakAtRisk ? 'Streak ⚠️' : 'Streak',
            value: '${_consecutiveDaysStreak}d',
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text('Review $_weaknessCount', style: const TextStyle(fontWeight: FontWeight.w800)),
                      style: weaknessStyle,
                    ),
                  ),
                ),
                    ...
                    builder: (context, isPremium, child) {
                      return SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Text('Bookmarks $_bookmarkCount', style: const TextStyle(fontWeight: FontWeight.w800)),
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(18),
              border: Border.all(color: const Color(0xFFFFB300).withValues(alpha: 0.8)),
              boxShadow: [
                BoxShadow(
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Text(
                        'No ads · Sequential mode · Bookmarks · Stats',
                        style: TextStyle(
                          fontSize: 11,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                _InfoSheetRow(
                                  label: 'Accuracy',
                                  value: answeredCount > 0 ? '$accuracyRate%' : 'N/A',
                                ...
                                _InfoSheetRow(
                                  label: 'Best Score',
                                  value: highScore > 0 ? '$highScore pts' : '--',
                                ...
                                _InfoSheetRow(
                                  label: 'Review',
                                  value: weaknessCount > 0 ? '$weaknessCount' : 'None',
        ...
        title: Row(
          children: [
            GestureDetector(
              onTap: () {
                _secretTapCount++;
                if (_secretTapCount >= 40) {
                  _secretTapCount = 0;
                  PurchaseManager.instance.silentUnlock();
                }
              },
              child: Container(
                width: 28,
...
class _CategoryStatusPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final headlineLabel = weaknessCount > 0 ? 'Review' : 'Questions';
    final headlineValue = weaknessCount > 0 ? '$weaknessCount' : '$questionCount';
          ...
          Row(
            children: [
              ...
              Text(
                !hasAnswered
                    ? 'Not started'
                    : (completionRate >= 1.0 ? 'Done' : '$completionPercent%'),
                style: TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.w900,
                  color: completionRate >= 1.0
                ...
                GestureDetector(
                  ...
                  child: const Column(
                    children: [
                      ...
                      Text("False", style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
                GestureDetector(
                  ...
                  child: const Column(
                    children: [
                      ...
                      Text("True", style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ],
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'New practice question app now available',
                      style: TextStyle(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 4),
                                            Text("Image question", style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                                          ],
                                        ),
                                      ),
                                  ],
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(widget.isWeaknessReview ? "Back to Home" : "Retry"),
                          ),
                        ),
                      ),
                    ],
